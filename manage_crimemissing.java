 ...
 * 
 */
public class manage_crimemissing extends javax.swing.JFrame {

    /**
     * Creates new form disp
     */
    dbhelper db=new dbhelper();
    public manage_crimemissing() {
        initComponents();
        dbin();
        
    }
     public manage_crimemissing(int s) {
        initComponents();
...
public void dbin()
{
    ...
    private void initComponents() {
        ...
        tab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "crime number", "name", "date", "status", "Location", "Case/Missing details"
            }
        ) {
        ...
        jLabel8.setText("case/missing details");
...
int selectedrow=0;
    ...
    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        ...
        try {  
            ob.dbcallup("delete from crime where caseno='"+tab.getModel().getValueAt(selectedrow, 0)+"'");
            this.dispose();
            new manage_crimemissing().setVisible(true);
...
//        new home().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        dbhelper ob=new dbhelper();
        try {  
            ob.dbcallup("insert into crime values('"+id.getText()+"','"+name.getText()+"','"+date.getText()+"','"+status.getText()+"','"+loc.getText()+"','"+add.getText()+"')");
            this.dispose();
            new manage_crimemissing().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         dbhelper ob=new dbhelper();
        try {  
            ob.dbcallup("update crime set status='"+jTextField1.getText()+"' where caseno='"+tab.getModel().getValueAt(selectedrow, 0)+"'");
            this.dispose();
            new manage_crimemissing().setVisible(true);
            jLabel6.setText("number Created");
        } catch (Exception ex) {
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        // TODO add your handling code here:
        String str="select * from crime where caseno like '"+jTextField2.getText()+"%'";
        tab.removeAll();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manage_crimemissing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
